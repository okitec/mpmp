...
-----------------------
Die Dateien "field_trainstation" und "field_street" (sowie "field_elecricity" und "field_waterpump")
sollen bearbeitet werden. Hier kann man die Straßenfarbe, ihren Namen und den Kaufpreis festlegen.
...
Die benötigten Dateien liegen (wahrscheinlich illegal) in /graphics/fonts/
...
"Weimarer Straße" wird nun als einzeiliger Straßenname angezeigt. Bei kurzen Namen reicht
das völlig aus.
````SVG
	<text id = "Einzeilig"
...
"Weimarer Straße" wird nun als zweizeiliger Straßenname angezeigt. Hilfreich bei längeren
Namen.
````SVG
	<text id = "Zweizeilig"
...
Dunkles Lila | ```#30041c```
Helles Blau | ```#91c3d8```
Helles Lila | ```#860459HILFE! Ich hab eine SVG!
========================
Warum SVG?
----------
Es ist eine vektorbasierte Grafik. Das heißt, man kann sie beliebig groß und klein machen,
